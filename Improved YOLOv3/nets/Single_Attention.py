...
class PatchEmbed(nn.Module):
    def __init__(self, input_shape=[224, 224], patch_size=16, in_chans=3, num_features=3, norm_layer=None,
                 flatten=True):
        super().__init__()
        ...
        # self.conv = nn.Conv2d(768, 30, 1, 1)
...
class Block(nn.Module):
    def __init__(self, dim,  mlp_ratio=4., qkv_bias=False, drop=0., attn_drop=0.,
        ...
        self.attn = Attention(dim, qkv_bias=qkv_bias, attn_drop=attn_drop, proj_drop=drop)
...
class SingleVisionTransformer(nn.Module):
    def __init__(
            self, input_shape=[224, 224], patch_size=16, in_chans=3, num_classes=1000, num_features=768,
            depth=12, mlp_ratio=4., qkv_bias=True, drop_rate=0.1, attn_drop_rate=0.1, drop_path_rate=0.1,
        ...
        # self.conv2 = nn.Conv2d(30, 768, 1, 1)

        # SingleVisionTransformer()
